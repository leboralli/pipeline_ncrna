...
#Escolhendo o servidor - NGS ou NGS3
#NGS e outros
# listOfFiles = GF.getListOfFastq(GF.dirName("/home/boralli/workdir/data"))
# list_fastpFiles = GF.getListOfFastq(GF.dirName("/home/boralli/workdir/FASTP"))
#NGS#
listOfFiles = GF.getListOfFastq(GF.dirName("/homelocal/boralli/workdir/data"))
list_fastpFiles = GF.getListOfFastq(GF.dirName("/homelocal/boralli/workdir/FASTP"))
# print(listOfFiles)
